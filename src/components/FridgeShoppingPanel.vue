      ...
      >
        ...
        <div class="shopping-items">
          <div
            ...
            :key="item.id"
            class="shopping-item"
            :class="{ purchased: item.purchased, 'from-expiring': item.fromExpiring, 'from-mealplan': item.fromMealPlan }"
          >
...
.shopping-budget-summary.over-budget {
...
.expiry-rules-dialog-footer .btn-primary {
  width: auto;
  padding: 8px 20px;
}

.expiry-rules-dialog-footer .btn-danger {
  width: auto;
  padding: 8px 16px;
}
